...
$functions = array(
    ...
    'local_course_get_sections' => array(
         'classname' => 'local_sync_service_external',
         'methodname' => 'get_sections',
         'classpath' => 'local/sync_service/externallib.php',
         'description' => 'Get section settings',
         'type' => 'create',
         'capabilities' => 'moodle/course:view',
    ),
    'local_course_update_sections' => array(
         'classname' => 'local_sync_service_external',
         'methodname' => 'update_sections',
         'classpath' => 'local/sync_service/externallib.php',
         'description' => 'Update section settings',
         'type' => 'create',
    ...
    'local_course_add_new_course_module_directory' => array(
        ...
        'classpath' => 'local/sync_service/externallib.php',
        'description' => 'Add course module Folder',
        'type' => 'write',
        'ajax' => true,
    ...
    'local_course_update_course_module_label' => array(
        ...
        'classpath' => 'local/sync_service/externallib.php',
        'description' => 'Update course module of type Label (aka Text and Media)',
        'type' => 'write',
        'ajax' => true,
